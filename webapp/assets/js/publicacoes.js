...
function curtirPublicacao(evento) {
    ...
    const publicacaoId = elementoClicado.closest('div').data('publicacaoId');
    ...
    $.ajax({
        ...
        elementoClicado.addClass('texte-danger');
...
function descurtirPublicacao(evento) {
    ...
    $.ajax({
        ...
        elementoClicado.removeClass('texte-danger');
...
function deletarPublicacao(evento) {
    ...
    Swal.fire({
        ...
        const publicacaoId = publicacao.data('publicacaoId');
